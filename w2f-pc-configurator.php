...
class W2F_PC_Configurator {
	...
	public function initialize_plugin() {
		...
		// Initialize NEW compatibility engine (v2.0).
		W2F_PC_Compatibility_Engine::instance();

		// Initialize legacy compatibility manager (delegates to new engine).
		...
		if ( is_admin() ) {
			...
			W2F_PC_Admin_Compatibility::instance();
		}
	...
	public function includes() {
		...
		// NEW: Compatibility Engine (v2.0 - replaces legacy manager).
		require_once W2F_PC_ABSPATH . 'includes/compatibility/class-w2f-pc-compatibility-engine.php';

		// Legacy Compatibility manager (kept for backward compatibility, delegates to new engine).
	...
	private function admin_includes() {
		...
		// NEW: Admin Compatibility pages (v2.0 - new compatibility system UI).
		require_once W2F_PC_ABSPATH . 'includes/admin/class-w2f-pc-admin-compatibility.php';
	}
